...
function exeption_list_upload()
{
	...
	foreach($aSheet->getRowIterator() as $row)
	{
		...
		{
			if ($vals[0]!='ID' || $vals[1]!='Название' || $vals[2]!='Поддомен' || $vals[5]!='E-mail' || count($vals)!=12){ // Проверяем данные, находящиеся в файле
