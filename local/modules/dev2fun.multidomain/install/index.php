...
//		$path = substr($path, 0, strlen($path) - strlen("/index.php"));
	...
	private function _installDomains() {
		...
		$hl->addField($hlId,[
			'FIELD_NAME' => 'UF_INCITY',
			'USER_TYPE_ID' => 'string',
			'SORT' => '160',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'EDIT_FORM_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_INCITY'),
				'en' => 'In city',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_INCITY'),
		...
		$hl->addField($hlId,[
			...
			'MANDATORY' => 'N',
			'EDIT_FORM_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_MAIL'),
				'en' => 'E-mail',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_MAIL'),
		...
		$hl->addField($hlId,[
			...
			'MANDATORY' => 'N',
			'EDIT_FORM_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_MAP'),
				'en' => 'Contact map',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_MAP'),
		...
		$hl->addField($hlId,[
			...
			'MANDATORY' => 'N',
			'EDIT_FORM_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_PHONE'),
				'en' => 'Phone',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_PHONE'),
		...
		$hl->addField($hlId,[
			...
			'MANDATORY' => 'N',
			'EDIT_FORM_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_ADRESS'),
				'en' => 'ADRESS',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_ADRESS'),
		...
		$hl->addField($hlId,[
			...
			'EDIT_FORM_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_ROBOTS'),
				'en' => 'robots.txt',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => Loc::getMessage('D2F_MULTIDOMAIN_INSTALL_EDIT_FORM_LABEL_UF_ROBOTS'),
	...
	private function _installSeo() {
		...
		$hl->addField($hlId,[
			...
			'EDIT_FORM_LABEL' => [
				'ru' => 'SEO-Text(О компании)',
				'en' => 'SEO-Text(О компании)',
			],
			'LIST_COLUMN_LABEL' => [
				'ru' => 'SEO-Text(О компании)',
				'en' => 'SEO-Text(О компании)',
