...
//if(class_exists('Dev2fun\MultiDomain\HLHelpers')) return;
...
class HLHelpers {
	 ...
	 * @param array $arFields https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=43&LESSON_ID=3496
	 * @throws $LAST_ERROR
	 * @return int
	 */
