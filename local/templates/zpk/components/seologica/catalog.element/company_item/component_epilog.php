...
if (!isset($pageSettings['UF_TITLE'])){
	$pageSettings['UF_TITLE'] = 'Компания '.$arResult['NAME']." - цены на строительство заборов под ключ в ##IN_CITY##";
}
if (!isset($pageSettings['UF_DESCRIPTION'])){
	$pageSettings['UF_DESCRIPTION'] = "Установка заборов от ".$arResult['NAME']." в ##IN_CITY##. Работа по официальному договору с соблюдением сроков. Гарантии. Сертифицированный материал. Отзывы.";
}
$APPLICATION->SetPageProperty('pageSettings', $pageSettings);