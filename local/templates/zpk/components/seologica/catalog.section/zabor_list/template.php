						...
						<a class="territory__link " href="<?=$object['DETAIL_PAGE_URL']?>" style="background-image:url(<?=$objPhoto['src']?>)">
							...
							<div class="territory__item-content">
								<div class="territory__item-header">
									<div class="territory__item-date"><?=date('d.m.y',strtotime($object['DATE_CREATE']))?></div>
								...
								<div class="territory__item-desc">
									<div class="territory__desc-content">
										...
										<div class="territory__el_value"><?=$object['PROPERTIES']['HEIGHT']['VALUE']?> метра</div>
									</div>
									<div class="territory__desc-content">
										<div class="territory__el_color">Длина</div>
										<div class="territory__el_rgb"><?=$object['PROPERTIES']['LENGTH']['VALUE']?> метров</div>
									</div>
									<div class="territory__desc-content">
										<div class="territory__el_price">Стоимость</div>
										<div class="territory__el_number"><?=number_format($object['PROPERTIES']['PRICE']['VALUE'],0,false,' ')?> р</div>
									</div>
								</div>
							</div>
						</a>
