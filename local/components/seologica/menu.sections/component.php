	...
	else
	{
		...
		while($arSection = $rsSections->GetNext())
		{
			...
			$arResult["SECTIONS"][] = array(
				...
				"MENU_DESCRIPTION" => $arSection["UF_MENU_DESCRIPTION"],
				"MENU_IMG" => $arSection["UF_MENU_IMG"],
...
foreach($arResult["SECTIONS"] as $arSection)
{
	...
	$aMenuLinksNew[$menuIndex++] = array(
		...
		array(
			...
			"IS_PARENT" => false,
			"DEPTH_LEVEL" => $arSection["DEPTH_LEVEL"],
			"MENU_DESCRIPTION" => $arSection["MENU_DESCRIPTION"],
			"MENU_IMG" => $arSection["MENU_IMG"],
			"PRICE" => $arSection["PRICE"],
		),
	);
}
