...
<div class="row bx-<?=$arParams['TEMPLATE_THEME']?>">
	<div class='<?=($isSidebar ? 'col-md-9 col-sm-8' : 'col')?>'>
		...
		$elementId = $APPLICATION->IncludeComponent('seologica:catalog.element', 'bootstrap_v4', $componentElementParams,
			$component
		);
				...
				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				{
					...
					<div class="row mb-5">
						<div class="col" data-entity="parent-container">
							...
							<? $APPLICATION->IncludeComponent('seologica:catalog.section', 'bootstrap_v4', array(
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'SECTION_ID' => $arResult['VARIABLES']['SECTION_ID'],
									'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
